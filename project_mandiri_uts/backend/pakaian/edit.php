                                ...
                                <form method="POST" action="proses.php">
                                    <input type="hidden" name="idedit" value="<?=$result['id']?>" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="ukuran" name="ukuran"  value="<?=$result['ukuran']?>" type="text" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="warna" class="form-label">Warna</label>
                                            <input id="warna" name="warna"  value="<?=$result['warna']?>" type="text" class="form-control" required>
                                        </div>
                                        <div class="form-group">
